...
IF(OPTION_SIMCOUPLER)
  # Boost
  MACRO(ADD_BOOST_INCLUDEDIR)

    IF(HAVE_BOOST)
      INCLUDE_DIRECTORIES(${Boost_INCLUDE_DIRS})
    ELSE(HAVE_BOOST)
      MESSAGE(FATAL_ERROR "Cannot find Boost header files")
    ENDIF(HAVE_BOOST)

  ENDMACRO(ADD_BOOST_INCLUDEDIR)

  MACRO(ADD_BOOST_LIBRARY TARGET)
  ...
  ENDMACRO(ADD_BOOST_LIBRARY TARGET)

  # Protobuf
  MACRO(ADD_PROTOBUF_INCLUDEDIR)

    IF(HAVE_PROTOBUF)
      INCLUDE_DIRECTORIES(${PROTOBUF_INCLUDE_DIRS})
    ELSE(HAVE_PROTOBUF)
      MESSAGE(FATAL_ERROR "Cannot find Protobuf header files")
    ENDIF(HAVE_PROTOBUF)

  ENDMACRO(ADD_PROTOBUF_INCLUDEDIR)
  ...
  MACRO(ADD_PROTOBUF_LIBRARY TARGET)
    ...
    ELSE(HAVE_PROTOBUF)
      MESSAGE(FATAL_ERROR "Cannot find Protobuf libraries")
    ENDIF(HAVE_PROTOBUF)

  ENDMACRO(ADD_PROTOBUF_LIBRARY TARGET)
