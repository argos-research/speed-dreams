...
MACRO(ADD_SDLIB_INCLUDEDIR)
  ...
  FOREACH(SDLIB_LIB ${ARGN})
    ...
    ELSEIF(SDLIB_LIB STREQUAL "sensors")
      IF(IN_SOURCETREE)
        SET(INCLUDE_CANDIDATE ${SOURCE_DIR}/src/libs/sensors)
      ELSE(IN_SOURCETREE)
        SET(INCLUDE_CANDIDATE ${SD_INCLUDEDIR_ABS})
      ENDIF(IN_SOURCETREE)
      FIND_PATH(SDLIB_SENSORS_INCLUDE_DIR positionTracker.h PATHS ${INCLUDE_CANDIDATE} /usr/include /usr/local/include NO_DEFAULT_PATH)
