/***************************************************************************
    ...
    version     : $Id: mainnfs2ac.cpp 4975 2012-09-30 21:54:35Z pouillot $                                  
...
{ 
	...
	//NormTblOffset = * ((int *)(mem + 0x0018)); // Never used.
	...
	//NormTblOffset = * ((int *)(mem + 0x0014)); // Never used.
