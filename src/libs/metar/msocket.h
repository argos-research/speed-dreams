...
//
// $Id: sg_socket.hxx,v 1.6 2006-03-08 18:16:08 mfranz Exp $
...
#define M_MAX_SOCKET_QUEUE 32


/**
 * A socket I/O class based on MIOChannel.
 */
class MSocket : public MIOChannel 
{
public:
private:
    string hostname;
    ...
    char save_buf[ 2 * M_IO_MAX_MSG_SIZE ];
    int save_len;
...
public:
     ...
     */
    MSocket( const string& host, const string& port, const string& style );
    ...
    bool open( const MProtocolDir d );
