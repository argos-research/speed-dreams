    ...
    max_alpha(1.0)
{
    ...
    WhiteTexture->setWrap(osg::Texture::WRAP_S, osg::Texture::CLAMP_TO_EDGE);
    WhiteTexture->setWrap(osg::Texture::WRAP_T, osg::Texture::CLAMP_TO_EDGE);
...
void SDCloudLayer::rebuild()
{
    ...
    for (int i = 0; i < 4; i++)
    {
          ...
          geometry->setTexCoordArray(0, tl[i].get()/*, osg::Array::BIND_OVERALL*/);
